...
class Line(object):
    ...
    def line_plus(self, other_line):
        ...
        new_start_x = other_line.start.x + self.start.x
        new_start_y = other_line.start.y + self.start.y
        new_end_x = other_line.end.x + self.end.x
        new_end_y = other_line.end.y + self.end.y
